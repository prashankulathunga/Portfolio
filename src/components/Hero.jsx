        ...
        <div className="container mx-auto ">
          ...
          <div className="flex items-center justify-center pb-8 md:h-screen flex-col">
            <div className="px-4 md:px-12 flex justify-center flex-col gap-9 md:pt-18">
              ...
              <div className="md:flex md:items-center md:gap-12  md:pl-28">
                <img
              ...
              <p className=" text-3xl md:text-8xl font-extrabold md:-mt-6 text-center md:py-4 py-1 drop-shadow-xl text-transparent bg-gradient-to-r from-green-400 to-violet-500 bg-clip-text">
                Software Engineer
                <span className="text-white">|</span>
              </p>

              <div className="flex mx-auto gap-2 flex-col md:flex-row">
